...
class SpecImportValidationTest extends TestCase
{
    ...
    public function test_unpadded_valid_time_is_normalized(): void
    {
        ...
        // Surface the body on failure — CI can only show us assertion text.
        $this->assertSame(200, $resp->status(), 'spec import non-200 — body: ' . $resp->getContent());
        $resp->assertJson(['message' => 'ایمپورت مشخصات: 1 مورد']);
