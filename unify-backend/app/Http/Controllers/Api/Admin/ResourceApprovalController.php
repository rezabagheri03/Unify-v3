...
class ResourceApprovalController extends Controller
{
    ...
    public function approve(Request $request, $id)
    {
        ...
        \App\Models\AuditLog::record($request->user()->id, 'resource_approved', 'resource', $resource->id, $request);
    ...
    public function reject(Request $request, $id)
    {
        ...
        \App\Models\AuditLog::record($request->user()->id, 'resource_rejected', 'resource', $resource->id ?? $id, $request, [
