...
class AuthController extends Controller
{
    public function login(Request $request)
    {
        ...
        if (!$user || !Hash::check($request->password, $user->password_hash)) {
            ...
            \App\Models\AuditLog::create([
                ...
                // Round-2 (V2-08): plain JSON like every other producer (the no-secrets
                // policy makes encryption pointless theater here — 'reason' is not sensitive).
                'details' => json_encode(['reason' => 'invalid_credentials']),
            ]);
    ...
    public function changePassword(Request $request)
    {
        ...
        // Post-audit F-16: the old ['rounds' => 12] option was silently IGNORED
        // (bcrypt-only; default driver is argon2id — config/hashing.php).
